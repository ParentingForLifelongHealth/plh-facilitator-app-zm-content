...
config.app_config.APP_SIDEMENU_DEFAULTS.title = "PLH implementers app";
config.app_config.APP_HEADER_DEFAULTS.title = "PLH implementers app";
config.app_config.NOTIFICATION_DEFAULTS.title = "New message from PLH implementers app";
config.app_config.NOTIFICATION_DEFAULTS.text = "You have a new message from PLH implementers app";
